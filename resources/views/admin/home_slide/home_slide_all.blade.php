         ...
         <div class="card-body">
            ...
            <!-- end row -->
                  <div class="row mb-3">
                     ...
                     <div class="col-sm-10">
                        <img name="home_slide" id="image" class="rounded avatar-lg" src="{{ (!empty($homeslide->home_slide))? url($homeslide->home_slide):url('upload/no_image.jpg') }}" alt="Card image cap">
                     </div>
                  </div>
                  <!-- end row -->
