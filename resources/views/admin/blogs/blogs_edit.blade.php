                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.blog', $blogs->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">                                                              
                                          <select name="blog_category_id" value="{{ $blogs->blog_category_id }}" class="form-select" aria-label="Default select example">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_title" value="{{ $blogs->blog_title }}" class="form-control" type="text"
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Blog Tags
                                    </label>
                                    <div class="col-sm-10">
